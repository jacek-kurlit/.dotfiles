...
-- Yanky FIXME: Yanky is not working
...
-- map("n", "]yl", "<Plug>(YankyPutIndentAfterLinewise)", "Put after linewise")
-- map("n", "[yl", "<Plug>(YankyPutIndentBeforeLinewise)", "Put before linewise")
-- map("n", "]yj", "<Plug>(YankyPutIndentAfterJoined)", "Put after joined")
-- map("n", "[yj", "<Plug>(YankyPutIndentBeforeJoined)", "Put before joined")
