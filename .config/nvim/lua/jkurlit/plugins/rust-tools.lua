...
local opts = {
	...
	server = {
		on_attach = function(client, bufnr)
			...
			vim.keymap.set("n", "<C-space>", rust_tools.hover_actions.hover_actions, keymap_opts)
			vim.keymap.set("n", "<Leader>a", rust_tools.code_action_group.code_action_group, keymap_opts)
